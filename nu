...
local ly = tableToString(pts)
    ...
    spawn(function()
      while wait() do
          if _G.Stats and contains(ly, "Fruit") then
              local args = {
                  [1] = "AddPoint",
                  [2] = "Demon Fruit",
                  [3] = tp
  ...
  spawn(function()
      while wait() do
          if _G.Stats and contains(ly, "Gun") then
              local args = {
                  [1] = "AddPoint",
                  [2] = "Gun",
                  [3] = tp
  ...
  spawn(function()
      while wait() do
          if _G.Stats and contains(ly, "Sword") then
              local args = {
                  [1] = "AddPoint",
                  [2] = "Sword",
                  [3] = tp
  ...
  spawn(function()
      while wait() do
          if _G.Stats and contains(ly, "Defense") then
              local args = {
                  [1] = "AddPoint",
                  [2] = "Defense",
                  [3] = tp
  ...
  spawn(function()
      while wait() do
          if _G.Stats and contains(ly, "Melee") then
              local args = {
                  [1] = "AddPoint",
                  [2] = "Melee",
                  [3] = 3
