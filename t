...
spawn(function()
  while wait() do
      if _G.Stats then
          for _, item in ipairs(ly) do
              if contains(item, "Melee") then
                  invokeServerWithArgs("Melee", tp)
              elseif contains(item, "Gun") then
                  invokeServerWithArgs("Gun", tp)
              elseif contains(item, "Sword") then
                  invokeServerWithArgs("Sword", tp)
              elseif contains(item, "Defense") then
